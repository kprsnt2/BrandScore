    ...
    return (
        <div className="w-full animate-slide-up">
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="relative">
                    <div className="relative">
                        <input
                            ...
                            className="w-full h-16 px-5 sm:px-6 pr-36 sm:pr-48 text-base sm:text-lg bg-[#0f1115] border border-white/[0.1] rounded-xl
                ...
                {/* Category Selection */}
                <div className="flex items-center gap-3 bg-white/[0.025] border border-white/[0.08] rounded-xl px-4 py-3 justify-between">
                    ...
                    <select
                        ...
                        disabled={loading}
                        className="bg-transparent text-sm focus:outline-none text-white font-medium cursor-pointer transition-colors hover:text-indigo-200 disabled:opacity-50"
                    >
            ...
            <div className="mt-5 flex flex-wrap items-center gap-2">
                ...
                {popularBrands.map((b) => (
                    <button
                        ...
                        disabled={loading}
                        className="px-3.5 py-1.5 text-xs bg-white/[0.025] hover:bg-white/[0.05] border border-white/[0.08] hover:border-white/[0.14] text-slate-400 hover:text-white rounded-full transition-colors duration-200 disabled:opacity-50"
                    >
                        {b.name}
                    </button>
                ))}
