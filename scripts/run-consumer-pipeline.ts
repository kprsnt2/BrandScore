...
import { getAllConsumerIndustries } from '../src/lib/consumer-industry-data';
...
async function main() {
  ...
  const industries = getAllConsumerIndustries();
  ...
  const results = await pipeline.analyzeAllIndustries(industries);
